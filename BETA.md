...
1. Go to **Algorithms** and click **Load example strategy** (or *Import* and pick a file from the `examples/` folder in the repo — `RSI_Dip_Hunter.apex.json` is a good start).
